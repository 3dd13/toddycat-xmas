  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved bookshelf as @bookshelf" do
        ...
        post :create, {:bookshelf => { "name" => "invalid value" }}, valid_session
        assigns(:bookshelf).should be_a_new(Bookshelf)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested bookshelf" do
        ...
        Bookshelf.any_instance.should_receive(:update).with({ "name" => "MyString" })
        put :update, {:id => bookshelf.to_param, :bookshelf => { "name" => "MyString" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the bookshelf as @bookshelf" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Bookshelf.any_instance.stub(:save).and_return(false)
        put :update, {:id => bookshelf.to_param, :bookshelf => { "name" => "invalid value" }}, valid_session
        assigns(:bookshelf).should eq(bookshelf)
      end
