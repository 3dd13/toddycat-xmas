...
describe BooksController do
  ...
  let(:valid_attributes) { { "bookshelf_id" => "1" } }
  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved book as @book" do
        ...
        post :create, {:book => { "bookshelf_id" => "invalid value" }}, valid_session
        assigns(:book).should be_a_new(Book)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested book" do
        ...
        Book.any_instance.should_receive(:update).with({ "bookshelf_id" => "1" })
        put :update, {:id => book.to_param, :book => { "bookshelf_id" => "1" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the book as @book" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Book.any_instance.stub(:save).and_return(false)
        put :update, {:id => book.to_param, :book => { "bookshelf_id" => "invalid value" }}, valid_session
        assigns(:book).should eq(book)
      end
